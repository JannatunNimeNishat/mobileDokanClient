...
import { useCreateProductMutation, useGetSingleProductQuery, useUpdateProductMutation } from "../../redux/features/product/productApi";
...
const CreateVariant = () => {
 ...
 const [createProduct] = useCreateProductMutation();
  ...
  return (
    ...
    >
      <h2 style={{ marginBottom: "10px" }}>Create Product Variant</h2>
      <hr />
      <div 
      ...
      >
        ...
        >
          ...
          >
            <Col lg={10} style={{ marginRight: "20px" }}>
